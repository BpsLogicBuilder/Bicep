...
param functionAppName string = 'bps-app-${uniqueString(resourceGroup().id)}'

@description('Generate an identifier based on the Resource Group ID')
...
@allowed(['3.10','3.11', '7.4', '8.0', '9.0', '10.0'])
...
var deploymentStorageContainerName = 'app-package-${take(functionAppName, 32)}-${take(uniqueIdentifier, 7)}'
...
resource applicationInsights 'Microsoft.Insights/components@2020-02-02' = {
  name: 'bps appi-${uniqueIdentifier}'
  location: location
  kind: 'web'
  properties: {
...
resource storage 'Microsoft.Storage/storageAccounts@2023-05-01' = {
  name: 'bpsappstr${uniqueIdentifier}'
  location: location
  kind: 'StorageV2'
...
resource userAssignedIdentity 'Microsoft.ManagedIdentity/userAssignedIdentities@2023-01-31' = {
  name: 'bps-app-${uniqueIdentifier}-uami'
  location: location
}
...
resource appServicePlan 'Microsoft.Web/serverfarms@2024-04-01' = {
  name: 'bps-plan-${uniqueIdentifier}'
  location: location
  kind: 'functionapp'
  sku: {
